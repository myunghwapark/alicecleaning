...
public class YoutubeVideoAdapter extends RecyclerView.Adapter<YoutubeViewHolder> {
    ...
    public YoutubeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.layout_youtube_video_custom, parent, false);
    ...
    public void onBindViewHolder(YoutubeViewHolder holder, final int position) {
        ...
        holder.videoThumbnailImageView.initialize(AppSettings.YOUTUBE_PLAYER_KEY, new YouTubeThumbnailView.OnInitializedListener() {
            @Override
